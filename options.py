...
def set():
    ...
    parser.add_argument("--use-ae",         type=int, default=0,                help="use pretrained AE process data as MIOFlow. We suggest NOT to do")
    parser.add_argument("--ae-emb-dim",     type=int, default=-1,               help="Embedding data to which dimension")
    ...
    # parser.add_argument("--exp-coef",       type=float,default=1,         help=" signal-to-noise ratio")
    ...
    # parser.add_argument("--test-bs",        type=int, default=5000,       help="[sb train] batch size for all trajectory sampling purposes")
    parser.add_argument("--num-itr",        type=int,                     help="[sb train] number of training iterations (for each epoch)")
    # parser.add_argument("--SB-warmup",      type=int, default=0,          help="[dsm warmup train] batch size for sampling data")
